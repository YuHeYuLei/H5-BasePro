...
var PDFJS_moveX = 0
var PDFJS_moveY = 0
var PDFJS_touchDistance = ''
var PDFJS_previousPinchScale = ''
var PDFJS_startTime = 0
var PDFJS_startX = 0
var PDFJS_startY = 0
var PDFJS_NewtouchDistance = 0
...
function webViewertouchstart (e) {
	// console.log(e)
	// PDFJS_startTime = _getTime();
	// PDFJS_startX = e.touches[0].pageX;
	// PDFJS_startY = e.touches[0].pageY;
	...
	// 	PDFJS_touchDistance = _getDistance(xLen, yLen);
	// }
}
function webViewertouchmove (e) {
	// console.log(e)
	// PDFJS_moveX = e.touches[0].pageX;
	// PDFJS_moveY = e.touches[0].pageY;
	// if(e.touches.length > 1) {
	// 	let xLen = Math.abs(e.touches[0].pageX - e.touches[1].pageX);
	// 	let yLen = Math.abs(e.touches[0].pageY - e.touches[1].pageY);
	// 	PDFJS_NewtouchDistance = _getDistance(xLen,yLen);
	// 	console.log(PDFJS_NewtouchDistance)
	// 	if(PDFJS_touchDistance) {
	// 	  let pinchScale = PDFJS_NewtouchDistance / PDFJS_touchDistance;
	// 	  PDFJS_previousPinchScale = pinchScale
	// 	  let timestamp = _getTime();
	// 	  if(timestamp - PDFJS_startTime > 100) {
	// 		if (PDFJS_previousPinchScale > 1) {
	// 			PDFViewerApplication.zoomIn();
	// 			// PDFViewerApplication.pdfViewer.currentScaleValue = PDFViewerApplication.pdfViewer.currentScaleValue - 1 + 1.1
	// 		} else if (PDFJS_previousPinchScale < 1) {
	// 			PDFViewerApplication.zoomOut();
	// 			// PDFViewerApplication.pdfViewer.currentScaleValue = PDFViewerApplication.pdfViewer.currentScaleValue - 1 + 0.9
	// 		} else {}
	// 		console.log(PDFViewerApplication.pdfViewer.currentScaleValue)
	// 		PDFJS_startTime = timestamp
...
var defaultOptions = {
  ...
  disableCreateObjectURL: {
    value: false,
    compatibility: _pdfjsLib ? _pdfjsLib.apiCompatibilityParams.disableCreateObjectURL : _pdfjsLib,
    kind: OptionKind.API
  },
  disableFontFace: {
    value: false,
...
function () {
  ...
  _createClass(AppOptions, null, [{
    ...
    value: function get(name) {
      var userOption = userOptions ? userOptions[name] : undefined;

      if (userOption !== undefined) {
        return userOption;
      }

      var defaultOption = defaultOptions ? defaultOptions[name] : undefined;
    ...
    value: function renderView(view) {
      ...
      switch (view.renderingState) {
        ...
        case RenderingStates.INITIAL:
          this.highestPriorityPage = view.renderingId;
		  console.log('RenderingStates.INITIAL')
  ...
  _createClass(PDFLinkService, [{
    ...
    value: function navigateTo(dest) {
      ...
      var goToDestination = function goToDestination(_ref2) {
		...
		console.log('scrollPageIntoView31')
    ...
    value: function setHash(hash) {
      ...
      if (hash.includes('=')) {
        ...
        if (dest) {
			console.log('scrollPageIntoView2')
...
function () {
  ...
  _createClass(PDFThumbnailView, [{
    ...
    value: function _getPageDrawContext() {
	  ...
	  console.log('_getPageDrawContext')
      return ctx;
    }
  }, {
    ...
    value: function _convertCanvasToImage() {
      var _this = this;
	  console.log('_convertCanvasToImage')
      if (!this.canvas) {
        return;
      }
...
function (_BaseViewer) {
  ...
  _createClass(PDFViewer, [{
    ...
    value: function _scrollIntoView(_ref) {
		...
		console.log('Key_scrollIntoView')
	  ...
	  console.log('_getPrototypeOf(PDFViewer.prototype)')
...
function () {
  ...
  _createClass(BaseViewer, [{
    ...
    value: function _setCurrentPageNumber(val) {
		console.log('_setCurrentPageNumber')
    ...
    key: "_scrollIntoView",
    value: function _scrollIntoView(_ref) {
		console.log('_scrollIntoView_ref')
      var pageDiv = _ref.pageDiv,
          _ref$pageSpot = _ref.pageSpot,
          pageSpot = _ref$pageSpot === void 0 ? null : _ref$pageSpot,
          _ref$pageNumber = _ref.pageNumber,
    ...
    value: function _setScaleUpdatePages(newScale, newValue) {
      ...
      if (!noScroll) {
		...
		console.log('scrollPageIntoView3')
    ...
    value: function _resetCurrentPageView() {
	  ...
	  console.log('_resetCurrentPageView')
    ...
    value: function scrollPageIntoView(_ref3) {
      ...
      if (!pageView) {
		...
		console.log('scrollPageIntoView(_ref3)')
	...
	console.log('scale === page-fit')
      ...
      if (!allowNegativeOffset) {
		...
		console.log('scrollPageIntoView')
      this._scrollIntoView({
        pageDiv: pageView.div,
        pageSpot: {
          left: left,
    ...
    value: function _updateScrollMode() {
      ...
      if (this._currentScaleValue && isNaN(this._currentScaleValue)) {
		...
		console.log('_updateScrollMode_2')
      this._setCurrentPageNumber(pageNumber, true);
...
;
var DISABLE_CREATE_OBJECT_URL = _pdfjsLib && _pdfjsLib.apiCompatibilityParams.disableCreateObjectURL || false;
